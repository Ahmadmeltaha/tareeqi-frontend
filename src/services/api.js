...
export const rideAPI = {
  ...
  getDriverRides: (driverId, params) => api.get(`/rides/driver/${driverId}`, { params }),
...
export const bookingAPI = {
  ...
  getPassengerBookings: (passengerId, params) => api.get(`/bookings/passenger/${passengerId}`, { params }),
